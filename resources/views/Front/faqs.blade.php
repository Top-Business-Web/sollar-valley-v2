...
<div class="module-content module-search-warp">
              ...
              <div class="card">
                <div class="card-heading">
                  <a
                    ...
                    role="button"
                    aria-expanded="false"
                    aria-controls="collapse01-7"
                    href="#collapse01-7"
                    >What if I pick the wrong plan?</a
                  >
                </div>
                <div
                  class="collapse"
              ...
              <div class="card">
                <div class="card-heading">
                  <a
                    ...
                    role="button"
                    aria-expanded="false"
                    aria-controls="collapse01-9"
                    href="#collapse01-9"
                    >Any contracts or commitments?</a
                  >
                </div>
                <div
                  class="collapse"
  ...
  <section
    class="counters counters-1 bg-overlay bg-overlay-theme2"
    id="counters-1"
  >
    <div class="bg-section">
    ...
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-6 offset-lg-1">
            <p class="heading-desc">
              ...
              in the North America and Europe. Our sales offices and
            ...
            <div class="actions-holder">
              <a
                ...
                href="page-contact.html"
              >
                awards & milestones<i class="energia-arrow-right"></i
              ></a>
            </div>
          </div>
        </div>
      ...
      <div class="row">
              ...
              <div class="img-hotspot-pointers">
                  ...
                  <div class="info" data-info-x="" data-info-y="">
                    <div class="border-outer">
                      <div class="border-inner">
                        <i class="flaticon-012-mining-1"></i>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div class="info" data-info-x="" data-info-y="">
                    <div class="border-outer">
                      <div class="border-inner">
                        <i class="flaticon-035-battery"></i>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div class="info" data-info-x="" data-info-y="">
                    <div class="border-outer">
                      <div class="border-inner">
                        <i class="flaticon-027-energy-tower"></i>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div class="info" data-info-x="" data-info-y="">
                    <div class="border-outer">
                      <div class="border-inner">
                        <i class="flaticon-032-recycle"></i>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div class="info" data-info-x="" data-info-y="">
                    <div class="border-outer">
                      <div class="border-inner">
                        <i class="flaticon-030-biology"></i>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="col-12 col-lg-3 offset-lg-1">
          ...
          <div class="counter counter-2">
            <div class="counter-num">
              <span class="counting" data-counterup-nums="2,512"
                >2,512</span
              >
              <h6>employees</h6>
            </div>
  ...
  <section class="blog blog-1 blog-grid" id="blog-1">
    <div class="container">
        ...
        <div class="col-12 col-lg-4">
          <div class="blog-entry" data-hover="">
            <div class="entry-content">
              ...
              <div class="entry-title">
                <h4>
                  <a href="blog-single.html"
                    >Filing Solar Power Permits in 2020? Consider Following
                    Important Factors</a
                  >
                </h4>
              </div>
                ...
                <div class="entry-img">
                  <a href="blog-single.html"
                    ><img
                      ...
                      alt="Filing Solar Power Permits in 2020? Consider Following Important Factors"
                  /></a>
                </div>
                <div class="entry-category">
                  <a href="blog-grid.html">solar</a
              ...
              <div class="entry-bio">
                <p>
                  All of these factors are important consider when
                  permitting your solar system, and can help streamline your
                  process. Take time to consider these.
                </p>
              </div>
          ...
          <div class="blog-entry" data-hover="">
            <div class="entry-content">
              ...
              <div class="entry-title">
                <h4>
                  <a href="blog-single.html"
                    >How to Add Battery Backup to an Existing Grid Tied
                    Solar System by Yourself!</a
                  >
                </h4>
              </div>
              <div class="entry-img-wrap">
                <div class="entry-img">
                  <a href="blog-single.html"
                    ><img
                      ...
                      alt="How to Add Battery Backup to an Existing Grid Tied Solar System by Yourself!"
                  /></a>
                </div>
                <div class="entry-category">
                  <a href="blog-grid.html">systems</a
                  ><a href="blog-grid.html">battery</a>
                </div>
              </div>

              <div class="entry-bio">
                <p>
                  Batteries are the most expensive part of a solar system.
                  Between appropriately-size battery bank and a
                  battery-based inverter like the Outback Radian.
                </p>
              </div>
              <div class="entry-more">
                <a
          ...
          <div class="blog-entry" data-hover="">
            <div class="entry-content">
              ...
              <div class="entry-title">
                <h4>
                  <a href="blog-single.html"
                    >Energy Department Research Will Help Eagles Coexist
                    with Wind Energy Deployment</a
                  >
                </h4>
              </div>
              <div class="entry-img-wrap">
                <div class="entry-img">
                  <a href="blog-single.html"
                    ><img
                      ...
                      alt="Energy Department Research Will Help Eagles Coexist with Wind Energy Deployment"
                  /></a>
                </div>
                <div class="entry-category">
                  <a href="blog-grid.html">research</a
                  ><a href="blog-grid.html">energy</a>
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-12">
          <div class="more-blog">
            <a href="blog-grid.html">find out more about our news!</a>
          </div>
        </div>
      </div>
    </div>
